...
Recommendation: **YES**
Score: `0.2055` (raw `-0.33` + doctrine-LLM nudge `-0.02`) | Confidence: `0.7714` | Readiness: `0.8`
...
BEACN's autonomous DRep recorded YES on "Eternl: Path to Sustainability - v2" (TreasuryWithdrawals). The action requests 2.35M ADA from the treasury. A key material claim lacks independent support: "Eternl is a non-custodial Cardano light wallet available on web, browser extension, Android, and iOS.". (Plain-language summary generated deterministically; a model-written explanation appears here when the reasoning layer is enabled.)
...
## Reproducibility
- input_hash: `e601c0f952ed945c36a1c5c9ff7f87616ea49bd07e2bc1dd9a903b73655a3f1b`
- snapshot_bundle_hash: `c6c65fd3b8cf92993b81b01cd0b69170a6e9bbcb7226eebcdc357ca5ea79a25a`
...
- decision_probs: `{"ABSTAIN": 0.2209, "NO": 0.0494, "YES": 0.7296}`
