...
- Claims and evidence missing: Independent evidence for: Custody of locked BTC is claimed to be distributed across 400+ Cardano SPOs weighted by delegation, with fund movement requiring a cryptographic threshold representing a majority of delegated stake.
...
- Provide independent evidence for: If SPO coordination fails, Bifrost claims a federated mode can activate as an operational fallback.
