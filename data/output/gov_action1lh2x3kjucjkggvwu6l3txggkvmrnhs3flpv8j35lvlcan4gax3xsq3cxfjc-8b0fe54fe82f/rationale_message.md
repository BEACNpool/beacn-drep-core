...
The action is a HardForkInitiation. The cached anchor describes the request as: Hard fork initiation to upgrade Cardano Mainnet to Protocol Version 11, minor version 0, via the intra-era 'van Rossem' hard fork.. The recorded treasury amount is 0. The strongest grounded claim is: The proposal would upgrade Cardano Mainnet to protocol version 11.0 through an intra-era hard fork while remaining in the Conway era.

A material weak point is that this claim remains proposer-asserted or thinly supported: UPLC will support case expressions over Bool, Integer, and Data, which the proposal says will improve performance and simplify script logic.
