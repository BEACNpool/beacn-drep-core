...
BEACN records NO on IO & VacuumLabs: Enhancing Plutus - Performance, Correctness, and Usability. On the evidence available to BEACN's published review, the request does not clear the bar for spending shared treasury funds.
